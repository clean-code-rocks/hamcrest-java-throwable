...
public class ExceptionMatcherTest {
    ...
    public void should_match_exception_type() {
        assertThat(() -> requireNonNull(null), new ExceptionMatcher(NullPointerException.class));
    }
    ...
    public void should_fail_when_exception_type_does_not_match() {
        AssertionError assertionError = assertThrows(
                ...
                () -> assertThat(() -> requireNonNull(null), new ExceptionMatcher(IllegalArgumentException.class))
        );
    ...
    public void should_fail_when_no_exception_is_thrown() {
        AssertionError assertionError = assertThrows(
                AssertionError.class,
                () -> assertThat(() -> requireNonNull("Dummy value"), new ExceptionMatcher(NullPointerException.class))
        );
