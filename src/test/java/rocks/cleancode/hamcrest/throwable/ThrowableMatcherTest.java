...
public class ThrowableMatcherTest {
    ...
    public void should_match_throwable_type() {
        assertThat(requireNonNull(null), new ThrowableMatcher(NullPointerException.class));
    }
    ...
    public void should_fail_when_throwable_type_does_not_match() {
        AssertionError assertionError = assertThrows(
                ...
                () -> assertThat(requireNonNull(null), new ThrowableMatcher(IllegalArgumentException.class))
        );
    ...
    public void should_fail_when_no_exception_is_thrown() {
        AssertionError assertionError = assertThrows(
                AssertionError.class,
                () -> assertThat(requireNonNull("Dummy value"), new ThrowableMatcher(NullPointerException.class))
        );
